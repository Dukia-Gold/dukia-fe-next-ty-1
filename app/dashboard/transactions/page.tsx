...
const TransactionPage = () => {
  ...
  return (
    <main className="w-full  text-dukiaBlue h-full mb-11 ">
      {transactions ? (
        <div>
          {transactions &&
          transactions.data &&
          transactions.data.length !== 0 ? (
            <div className="space-y-6 bg-white rounded-2xl py-2 px-4">
            ...
            <div className="h-[calc(100vh-20rem)] flex flex-col justify-center items-center">
              ...
              <div className="text-center space-y-1 text-sm">
                ...
                <p className="text-dukiaBlue/[65%]">
                  You have no Transactions to view. Click “Buy Gold” to perform
                  your first transaction or fund your wallet.
                </p>
              </div>
            </div>
          )}
