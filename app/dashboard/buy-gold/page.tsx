...
const BuyGoldPage = () => {
  return (
   <div className="bg-white px-4 py-3 rounded-xl">
    <div className="bg-dukiaGrey pt-12 px-4 rounded-xl">
        <p className="font-manrope text-[1.28rem] font-extrabold leading-[1.875rem] tracking-[-0.03em] text-center text-[#676D88]">Select Gold Type to Continue</p>
    <div className="gap-4 grid md:grid-cols-2 lg:grid-cols-3 px-4 pt-[2.5625rem] pb-[2.625rem]">
        <div className="bg-white rounded-lg group border hover:border-4 hover:border-dukiaBlue focus-within:border-dukiaBlue grid grid-rows-5 h-full">
        <div className="row-span-4 flex items-center justify-center">
    
        <Image 
           src="https://res.cloudinary.com/dvcw253zw/image/upload/v1722433132/Component_53_zevhoy.png"
           alt="Buy Gold Bar"
           width={460}
           height={400}
           />
        </div>
        <div className="row-span-1 py-[1.21875rem] px-4">
        ...
        <div className="col-span-1 ">
           ...
           <p className="pt-[0.625rem]">Lorem Ipsum dolor sit amet</p>
        </div>  
        </div>
        ...
        <div className="row-span-4 flex items-center justify-center">
           <Image 
           src="https://res.cloudinary.com/dvcw253zw/image/upload/v1722433471/Component_52_atedst.png"
           alt="Buy Gold Coin"
           width={460}
           height={400}
           />
