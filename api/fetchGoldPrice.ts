...
export const useFetchGoldPriceDollars = () => {
    ...
    return { ask, bid, fetchGoldPriceDollars };
};
...
export const useFetchGoldPriceNaira10g = () => {
    ...
    const fetchGoldPrice10g = async () => {
        try {
            const response = await fetch('https://api.dukiapreciousmetals.co/api/products/philoro-10g/withPrice');
            const data = await response.json();
...
export const useFetchGoldPriceNaira1oz = () => {
    ...
    const fetchGoldPrice1oz = async () => {
        try {
            const response = await fetch('https://api.dukiapreciousmetals.co/api/products/philoro-1oz/withPrice');
            const data = await response.json();
