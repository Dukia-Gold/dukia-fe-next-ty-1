  ...
  return (
    <div className="hidden py-2.5 bg-white border-b border-dukiaBlue/[10%] px-1.5 md:px-5 lg:px-10 font-extrabold text-3xl/10 sm:flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center gap-2">
        <Link href="/dashboard/card" className="p-3 rounded-[50%] bg-dukiaBlue/[5%]">
          <svg
            width="24"
            height="20"
            viewBox="0 0 24 20"
          ...
          >
            ...
            >
              <path
                d="M14 3.3335H10C6.229 3.3335 4.343 3.3335 3.172 4.31016C2.328 5.01266 2.092 6.02433 2.026 7.7085H21.974C21.908 6.02433 21.672 5.01266 20.828 4.31016C19.657 3.3335 17.771 3.3335 14 3.3335ZM10 16.6668H14C17.771 16.6668 19.657 16.6668 20.828 15.6902C22 14.7143 22 13.1427 22 10.0002C22 9.63183 22 9.28516 21.998 8.9585H2.002C2 9.28516 2 9.63183 2 10.0002C2 13.1427 2 14.7143 3.172 15.6902C4.343 16.6668 6.229 16.6668 10 16.6668Z"
                fill="white"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M5.25 13.3335C5.25 13.1677 5.32902 13.0088 5.46967 12.8916C5.61032 12.7743 5.80109 12.7085 6 12.7085H10C10.1989 12.7085 10.3897 12.7743 10.5303 12.8916C10.671 13.0088 10.75 13.1677 10.75 13.3335C10.75 13.4993 10.671 13.6582 10.5303 13.7754C10.3897 13.8926 10.1989 13.9585 10 13.9585H6C5.80109 13.9585 5.61032 13.8926 5.46967 13.7754C5.32902 13.6582 5.25 13.4993 5.25 13.3335ZM11.75 13.3335C11.75 13.1677 11.829 13.0088 11.9697 12.8916C12.1103 12.7743 12.3011 12.7085 12.5 12.7085H14C14.1989 12.7085 14.3897 12.7743 14.5303 12.8916C14.671 13.0088 14.75 13.1677 14.75 13.3335C14.75 13.4993 14.671 13.6582 14.5303 13.7754C14.3897 13.8926 14.1989 13.9585 14 13.9585H12.5C12.3011 13.9585 12.1103 13.8926 11.9697 13.7754C11.829 13.6582 11.75 13.4993 11.75 13.3335Z"
                fill="black"
              />
            </mask>
