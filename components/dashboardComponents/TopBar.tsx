...
const TopBar = () => {
  ...
  return (
    <>
      ...
      <div className="mt-6 py-2.5 bg-white border-b border-dukiaBlue/[10%] font-extrabold text-3xl/10 sm:flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2">
          <div className="p-3 rounded-[50%] bg-dukiaBlue/[5%]">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
          ...
          <div className="p-3 rounded-[50%] bg-dukiaBlue/[5%] cursor-pointer">
