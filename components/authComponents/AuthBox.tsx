...
const AuthBox = () => {
  ...
  return (
    <div className="bg-[#F3F3F4] flex flex-col min-h-[35rem] gap-6 items-center rounded-2xl px-5 w-[90%] md:w-auto md:px-10 pt-4 pb-10">
      <div>
        <Image
      ...
      <div className="flex border-b w-full border-dukiaBlue font-medium">
        <div
          className={`${
            tab === 0 ? " font-bold bg-dukiaBlue/[10%]" : ""
        ...
        <div
          className={`${
            tab === 1 ? " font-bold bg-dukiaBlue/[10%]" : ""
          } w-[50%] py-4 md:px-24 flex items-center justify-center cursor-pointer`}
          onClick={() => {
            setTab(1);
          }}
