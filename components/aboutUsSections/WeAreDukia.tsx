...
const WeAreDukia = ({ nextSectionRef }: WeAreDukiaProps) => {
  return (
    <section
      ref={nextSectionRef}
      className="px-3 py-14 text-dukiaBlue dark:bg-dukiaBlue dark:text-white"
    >
      <div className="md:container flex flex-col space-y-10">
        <div className="grid xl:grid-cols-2 gap-5 xl:gap-10">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-lg">
              ...
              in Nigeria, West Africa creating ease of access to investment
              grade gold & other precious metals in Nigeria via a safe and
              secure trading platform. Dukia Gold offers an easy, secure and
              accessible way to buy, sell, invest and do much more with gold.
              With Dukia Gold, you have full control and peace of mind over
              securing your financial future. <br /> <br />
              ...
              other precious metal materials, and refines it into investment
              grade ‘good delivery’ bar or coin. Dukia sells its finished
              products to high networth individuals and corporate investors such
              as banks and other financial institutions, including discerning
              corporates & individuals. <br /> <br />
              ...
              investor the opportunity to buy a product with high intrinsic
              value and an assured market when the investor chooses to liquidate
              its investment.
            </p>
          </div>
        </div>
        ...
        <div>
          <p className="text-lg">
            ...
            Precious Metal Bullion, Bars and Coins. With this, Dukia Gold set
            out on a journey that puts Nigeria on the global map and at par with
            the major Gold & Precious Metals refining and producing nations.{" "}
            <br />
            <br />
            ...
            Gold management has between them over 200years of hands on
            experience of the Gold and other Precious Metals sector both
            internationally and nationally. More importantly most of the
            management had been informally working together within the sector
            for at least 10 years pre-incorporation of Dukia Gold <br />
            <br />
            ...
            <br />
            The &apos;Good Delivery&apos; bar presented by Dukia Gold for sale
            in the investment marketplace is of .9999 purity and will afford the
        ...
        <div className="grid xl:grid-cols-2 gap-3 xl:gap-6">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-lg">
                To be recognised as &apos;The Gold Standard&apos; across the
                gold value chain in Africa, as an LBMA accredited processor and
                largest exporter of gold and other precious metal products from
                Nigeria.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-lg">
                To establish as a full-service bullion merchant and the first
                LBMA accredited Precious Metals refinery of its kind to locally
                produce good delivery investment bars and other bullion products
                for sale to investors and consumers and boost financial returns
                to miners & other stakeholders in the precious metals value
                chain.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-8">
          <div className="text-dukiaBlue dark:text-white text-center flex flex-col gap-2">
            ...
            <p className="text-lg">
              Lorem ipsum dolor sit amet consectetur. In morbi hac aliquam
              lacus. Lacus tristique euismod volutpat porttitor amet aliquet
              egestas. Porttitor ac purus metus quam blandit ipsum erat eget.
              Metus lectus auctor eu eros orci dui donec diam suspendisse.
            </p>
          </div>
