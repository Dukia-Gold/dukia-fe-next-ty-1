...
const Hero = () => {
  return (
    <section className="relative min-h-screen bg-hero-pattern bg-cover bg-no-repeat bg-center bg-fixed pt-48 xl:pt-36 py-4 flex items-center">
      ...
      <div className="container flex flex-col xl:flex-row justify-center xl:justify-between items-center gap-10">
        <div className="z-20 flex flex-col gap-6">
          ...
          <p>
            ...
            <h1 className="text-base sm:text-lg md:text-xl  font-semibold text-dukiaGrey">
