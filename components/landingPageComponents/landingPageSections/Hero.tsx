...
const Hero = () => {
  return (
    <section className="min-h-screen pt-48 xl:pt-24 px-3 md:px-12 xl:px-28 py-4 flex flex-col gap-10 xl:flex-row xl:justify-between items-center bg-gray-500">
