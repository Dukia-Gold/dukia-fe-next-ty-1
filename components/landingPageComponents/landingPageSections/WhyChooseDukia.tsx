      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6 grid-rows-subgrid">
        <div className="bg-dukiaGrey rounded-2xl border border-dukiaBlue/[5%] p-6 flex flex-col gap-3 items-center">
          ...
          <p className="text-sm text-center">
            ...
            as a bullion merchant in Nigeria and operates in line with the best
            standards and practices in adherence to all local and international
            regulations.
          </p>
        </div>
        ...
        <div className="bg-dukiaGrey rounded-2xl border border-dukiaBlue/[5%] p-6 flex flex-col gap-3 items-center">
          ...
          <p className="text-sm text-center">
            ...
            sell products of highest quality to you. We offer buyback on all our
            products at the best rate market rates.
          </p>
        </div>
        ...
        <div className="bg-dukiaGrey rounded-2xl border border-dukiaBlue/[5%] p-6 flex flex-col gap-3 items-center">
          ...
          <p className="text-sm text-center">
            Using our state-of-the-art, secure, and intuitive platform, you can
            buy, sell, invest and do much more wih gold with just a tap of a
            button.
          </p>
        </div>
        ...
        <div className="xl:col-start-1 xl:col-end-3 bg-dukiaGrey rounded-2xl border border-dukiaBlue/[5%] p-6 flex flex-col gap-3 items-center">
          ...
          <p className="text-sm text-center">
          For your peace of mind, your gold holdings are safe, secure, and insured with our designated third-party LBMA Vaulting Service Provider, Brink&apos;s. Products in transit are discreetly packed in a tamper-proof packaging and safely delivered to you.
          </p>
        </div>
