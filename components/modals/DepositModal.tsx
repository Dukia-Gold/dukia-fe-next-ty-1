  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-[#00000040] flex justify-center items-center transition-opacity duration-300">
      <ScrollArea className="bg-white animate-in fade-in-5 duration-500 ease-in-out text-dukiaBlue rounded-lg pt-5 pb-7 w-[95%] h-[75%] md:h-auto md:w-[38.3125rem] px-4 md:px-6 flex flex-col items-center">
        ...
        {/* Bank Transfer */}
        {bankTransfer && (
          <div className="mt-3 animate-in fade-in-5 border border-[#E7E8E9] rounded-[0.625rem] py-2 px-2.5 w-full space-y-2">
            {/* Header */}
            <div className="px-2 py-2.5 space-y-2 bg-[#4A8F510D] border border-[#4A8F510D]/[50%] rounded-lg">
              ...
              <ul className="text-xs font-medium text-dukiaBlue/[75%] space-y-1 list-disc pl-12">
                ...
                <li>
                  Please make the transfer from your registered bank account
                  with us.
                </li>

                <li>
                  Click on  &apos;I have made the Transfer&apos; button after
                  making the transfer on your Bank App/Internet Banking
                  Platform.
                </li>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="-space-y-[0.2rem] text-[0.625rem]">
                        <p className="font-semibold">
                          ...
                          <span className="underline text-dukiaGold">
                            browse
                          </span>
                        </p>
